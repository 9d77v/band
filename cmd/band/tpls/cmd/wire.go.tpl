...
import (
	...
	{{.SERVICE_LOWER}} "{{.PKG_DIR}}/internal/apps/{{.SERVICE_PACKAGE}}"
	"{{.PKG_DIR}}/internal/apps/{{.SERVICE_PACKAGE}}/application/service"
	"{{.PKG_DIR}}/internal/apps/{{.SERVICE_PACKAGE}}/infrastructure/persistence"
